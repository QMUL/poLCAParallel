...
#'     specified sets of responses `y`, based on the estimated latent class
#'     model `lc`. For each row (one case), the first column gives the posterior
...
#' f2 <- cbind(MORALG, CARESG, KNOWG, LEADG, DISHONG, INTELG, MORALB, CARESB,
#'             KNOWB, LEADB, DISHONB, INTELB) ~ AGE + EDUC + GENDER

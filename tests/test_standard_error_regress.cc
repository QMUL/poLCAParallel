...
/**
 * @file
 * Test the class polca_parallel::StandardErrorRegress
 *
 * Test the class polca_parallel::StandardErrorRegress. The class calculates the
 * standard error for the regression problem. The data is randomly generated as
 * well as the fitted prior and posterior. See
...
TEST_CASE("test-regress") {
  ...
  std::vector<unsigned> rng_seed_array = {2830108240, 3022924627, 3551928624};
